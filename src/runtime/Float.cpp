...
namespace snow {	
	...
	Object* float_prototype() {
		...
		proto->set_raw_s("%", new Function(numeric_mod));
		proto->set_raw_s("**", new Function(numeric_power));
		proto->set_raw_s("<", new Function(numeric_lt));
		proto->set_raw_s("<=", new Function(numeric_lte));
		proto->set_raw_s(">", new Function(numeric_gt));
		proto->set_raw_s(">=", new Function(numeric_gte));
		
		VALUE to_string = new Function(float_to_string);
